    ...
    <div className="space-y-1.5">
      <div className={`flex items-center ${touchMode ? 'gap-2' : 'gap-1'}`}>
        ...
        <input
          ...
          className={`min-w-[3rem] max-w-[5.5rem] text-center tabular-nums font-medium border border-gray-200 bg-white focus:outline-none focus:ring-1 focus:ring-blue-500 ${
            touchMode
              ? 'min-h-11 w-20 text-base px-2 py-1 rounded-lg'
              : 'w-16 text-sm px-1 py-1 rounded-md'
          }`}
          aria-label="Quantity"
        />
